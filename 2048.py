...
Write a program that will open the game at https://gabrielecirulli.github.io/2048/ and keep sending up, right, down, 
...
while True:
    ...
    try:
        retry_elem = browser.find_element(By.CLASS_NAME,'retry-button')
        retry_elem.click()
        continue
    except:
        continue
